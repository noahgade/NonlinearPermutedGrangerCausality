...
train_model_ista(cmlp1, dat, lam = 0.01, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GL', max_iter = 20000, check_every = 100)
grangerGL1 = cmlp1.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGL1.csv", grangerGL1, delimiter=",")

cmlp2 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp2, dat, lam = 0.05, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GL', max_iter = 20000, check_every = 100)
grangerGL2 = cmlp2.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGL2.csv", grangerGL2, delimiter=",")

cmlp3 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp3, dat, lam = 0.1, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GL', max_iter = 20000, check_every = 100)
grangerGL3 = cmlp3.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGL3.csv", grangerGL3, delimiter=",")

cmlp4 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp4, dat, lam = 0.5, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GL', max_iter = 20000, check_every = 100)
grangerGL4 = cmlp4.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGL4.csv", grangerGL4, delimiter=",")
