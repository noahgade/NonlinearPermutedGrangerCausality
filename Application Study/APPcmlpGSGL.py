...
train_model_ista(cmlp1, dat, lam = 0.01, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GSGL', max_iter = 20000, check_every = 100)
grangerGSGL1 = cmlp1.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGSGL1.csv", grangerGSGL1, delimiter=",")

cmlp2 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp2, dat, lam = 0.05, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GSGL', max_iter = 20000, check_every = 100)
grangerGSGL2 = cmlp2.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGSGL2.csv", grangerGSGL2, delimiter=",")

cmlp3 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp3, dat, lam = 0.1, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GSGL', max_iter = 20000, check_every = 100)
grangerGSGL3 = cmlp3.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGSGL3.csv", grangerGSGL3, delimiter=",")

cmlp4 = cMLP(dimension, lag = 40, hidden = [250], activation = "tanh")
train_model_ista(cmlp4, dat, lam = 0.5, lam_ridge = 1e-2, lr = 1e-3, penalty = 'GSGL', max_iter = 20000, check_every = 100)
grangerGSGL4 = cmlp4.GC(threshold = False, ignore_lag = True).detach().numpy()
np.savetxt("grangerGSGL4.csv", grangerGSGL4, delimiter=",")
